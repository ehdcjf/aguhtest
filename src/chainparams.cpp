...
{
    const char* pszTimestamp = "hello aguhcoin";
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1633065754, 358145, 0xfe00ffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x12a765e31ffd4059bada1e25190f6e98c99d9714d334efa41a195a7e7e04bfe2"));
        assert(genesis.hashMerkleRoot == uint256S("0x359073ad836c25cee1255bbd79cf03a9762f97a45163db6f3426a12fc645389b"));

        // Note that of those with the service bits flag, most only support a subset of possible options
        // vSeeds.emplace_back("seed-a.aguhcoin.loshan.co.uk", true);
        // vSeeds.emplace_back("dnsseed.thrasher.io", true);
        // vSeeds.emplace_back("dnsseed.aguhcointools.com", true);
        // vSeeds.emplace_back("dnsseed.aguhcoinpool.org", true);
        ...
        checkpointData = (CCheckpointData) {
            {
                {  1500, uint256S("0xbbfb4783cd4c0e3ad67784e13e1cf256f304233dde7d07eed69d6bf82b7f575a")}
        ...
        chainTxData = ChainTxData{
            ...
            1633065754, // * UNIX timestamp of last known number of transactions
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1633065754, 358145, 0xfe00ffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xbbfb4783cd4c0e3ad67784e13e1cf256f304233dde7d07eed69d6bf82b7f575a"));
        assert(genesis.hashMerkleRoot == uint256S("0x359073ad836c25cee1255bbd79cf03a9762f97a45163db6f3426a12fc645389b"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        vSeeds.emplace_back("testnet-seed.aguhcointools.com", true);
        vSeeds.emplace_back("seed-b.aguhcoin.loshan.co.uk", true);
        ...
        checkpointData = (CCheckpointData) {
            {
                {2056, uint256S("bbfb4783cd4c0e3ad67784e13e1cf256f304233dde7d07eed69d6bf82b7f575a")},
            }
        };
