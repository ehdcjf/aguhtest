...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s aguhcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  aguhcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded aguhcoin transaction") + "\n" +
              "  aguhcoin-tx [options] -create [commands]   " + _("Create hex-encoded aguhcoin transaction") + "\n" +
              "\n";
