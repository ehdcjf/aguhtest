...
const char * const BITCOIN_CONF_FILENAME = "aguhcoin.conf";
const char * const BITCOIN_PID_FILENAME = "aguhcoin.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Aguhcoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Aguhcoin";
#else
    // Unix
    return pathRet / ".aguhcoin";
#endif
#endif
}
