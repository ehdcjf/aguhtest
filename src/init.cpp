...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/aguhcoin-project/aguhcoin>";
    const std::string URL_WEBSITE = "<https://aguhcoin.org>";
